...
class _NotificationsWidgetState extends State<NotificationsWidget> {
  ...
  void initState() {
    ...
    _model.corpoMensagemTextController ??= TextEditingController();
    _model.corpoMensagemFocusNode ??= FocusNode();
  }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        width: double.infinity,
                        child: TextFormField(
                          controller: _model.corpoMensagemTextController,
                          focusNode: _model.corpoMensagemFocusNode,
                          autofocus: true,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: FFLocalizations.of(context).getText(
                              'ibumhydr' /* Corpo da Mensagem */,
                            ),
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                          ...
                          validator: _model.corpoMensagemTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await NotNotificacaoTable().insert({
                              'titulo': _model.txtTituloTextController.text,
                              'mensagem':
                                  _model.corpoMensagemTextController.text,
                              'fcmtoken': _model.tokenfcm,
                              'email': notificationsUsuariosRow?.email,
                              'nome': notificationsUsuariosRow?.nome,
                            });
                            setState(() {
                              _model.txtTituloTextController?.clear();
                              _model.corpoMensagemTextController?.clear();
                            });
                          },
