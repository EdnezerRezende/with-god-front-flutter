      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => DevotionalsEditWidget(
            ...
            prmIsUpdate: params.getParam(
              'prmIsUpdate',
              ParamType.bool,
            ),
            prmBookBible: params.getParam(
              'prmBookBible',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: 'DevotionalList',
          path: '/devotionalList',
          builder: (context, params) => const DevotionalListWidget(),
        ),
        FFRoute(
          name: 'Anuncios',
          path: '/anuncios',
        ...
        FFRoute(
          name: 'QuizPerguntas',
          path: '/quizPerguntas',
          builder: (context, params) => QuizPerguntasWidget(
            prmLevel: params.getParam(
              'prmLevel',
              ParamType.String,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) => QuizFinishWidget(
            prmRespostas: params.getParam<bool>(
              'prmRespostas',
              ParamType.bool,
              isList: true,
            ),
