...
class WithGoddevotionals2SupabaseUser extends BaseAuthUser {
  WithGoddevotionals2SupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> withGoddevotionals2SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = WithGoddevotionals2SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
