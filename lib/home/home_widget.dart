                    ...
                    child: FutureBuilder<List<OptionsCardMenuRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<OptionsCardMenuRow>
                            gridViewOptionsCardMenuRowList = snapshot.data!;
                        return GridView.builder(
                          ...
                          itemCount: gridViewOptionsCardMenuRowList.length,
                          itemBuilder: (context, gridViewIndex) {
                            final gridViewOptionsCardMenuRow =
                                gridViewOptionsCardMenuRowList[gridViewIndex];
                            return Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  8.0, 8.0, 8.0, 8.0),
                              child: InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  if (gridViewOptionsCardMenuRow.pageUrl ==
                                      'bible') {
                                    context.pushNamed(
                                      'Biblia',
